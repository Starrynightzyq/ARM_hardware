...
wire   [0:0] tmp_i_40_fu_192_p2;
reg   [0:0] tmp_i_40_reg_264;
wire   [0:0] tmp_13_i_fu_202_p2;
...
wire   [63:0] tmp_15_i_fu_218_p1;
reg    ap_block_pp0_stage0_01001;
wire   [32:0] lhs_V_cast_i_fu_171_p1;
wire   [32:0] tmp_12_cast_i_fu_198_p1;
wire   [15:0] storemerge_i_fu_223_p3;
wire   [15:0] tmp_16_i_fu_230_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_207_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        dst_buffer_addr_reg_282 <= tmp_15_i_fu_218_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond3_i_fu_181_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_13_i_reg_269 <= tmp_13_i_fu_202_p2;
        tmp_i_40_reg_264 <= tmp_i_40_fu_192_p2;
    end
end

always @ (*) begin
    if (((tmp_13_i_reg_269 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_13_i_reg_269 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((tmp_13_i_reg_269 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        dst_buffer_we1 = 1'b1;
    end else begin
        dst_buffer_we1 = 1'b0;
    end
...
assign Vdst_data_stream_V_din = tmp_4_reg_288;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((tmp_13_i_reg_269 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((tmp_13_i_reg_269 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((tmp_13_i_reg_269 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter2 = ((tmp_13_i_reg_269 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign dst_buffer_address0 = tmp_15_i_fu_218_p1;

assign exitcond3_i_fu_181_p2 = ((t_V_reg_149 == rows_V_reg_240) ? 1'b1 : 1'b0);

assign exitcond_i_fu_207_p2 = ((t_V_2_reg_160 == cols_V_reg_245) ? 1'b1 : 1'b0);

assign i_V_fu_186_p2 = (t_V_reg_149 + 32'd1);

assign j_V_fu_212_p2 = (t_V_2_reg_160 + 32'd1);

assign lhs_V_cast_i_fu_171_p1 = src_rows_V_dout;

assign r_V_fu_175_p2 = ($signed(lhs_V_cast_i_fu_171_p1) + $signed(33'd8589934591));

assign storemerge_i_fu_223_p3 = ((tmp_i_40_reg_264[0:0] === 1'b1) ? 16'd0 : dst_buffer_q0);

assign tmp_12_cast_i_fu_198_p1 = t_V_reg_149;

assign tmp_13_i_fu_202_p2 = ((tmp_12_cast_i_fu_198_p1 == r_V_reg_250) ? 1'b1 : 1'b0);

assign tmp_15_i_fu_218_p1 = t_V_2_reg_160;

assign tmp_16_i_fu_230_p1 = src_data_stream_V_dout;

assign tmp_4_fu_234_p2 = (storemerge_i_fu_223_p3 + tmp_16_i_fu_230_p1);

assign tmp_i_40_fu_192_p2 = ((t_V_reg_149 == 32'd0) ? 1'b1 : 1'b0);
