...
reg   [31:0] t_V_3_reg_233;
reg    ap_block_state1;
wire   [0:0] exitcond6_fu_244_p2;
wire    ap_CS_fsm_state2;
wire   [31:0] i_V_fu_249_p2;
reg   [31:0] i_V_reg_280;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond6_fu_244_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((exitcond6_fu_244_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_255_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        t_V_3_reg_233 <= j_V_fu_260_p2;
    end else if (((exitcond6_fu_244_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        t_V_3_reg_233 <= 32'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        exitcond_reg_285 <= exitcond_fu_255_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        i_V_reg_280 <= i_V_fu_249_p2;
    end
end
...
always @ (*) begin
    if (((exitcond6_fu_244_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((exitcond_reg_285 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_reg_285 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((exitcond_fu_255_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((exitcond_fu_255_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_285 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst2_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst1_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst0_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_285 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst2_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst1_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst0_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_reg_285 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst2_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst1_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (dst0_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_285 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)));
end
...
assign exitcond6_fu_244_p2 = ((t_V_reg_222 == src_rows_V) ? 1'b1 : 1'b0);

assign exitcond_fu_255_p2 = ((t_V_3_reg_233 == src_cols_V) ? 1'b1 : 1'b0);

assign i_V_fu_249_p2 = (t_V_reg_222 + 32'd1);

assign j_V_fu_260_p2 = (t_V_3_reg_233 + 32'd1);
