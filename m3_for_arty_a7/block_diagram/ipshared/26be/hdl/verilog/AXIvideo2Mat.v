...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond8_fu_368_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond_fu_379_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond8_fu_368_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((exitcond8_fu_368_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign exitcond8_fu_368_p2 = ((t_V_reg_233 == img_rows_V) ? 1'b1 : 1'b0);

assign exitcond_fu_379_p2 = ((t_V_8_reg_244 == img_cols_V) ? 1'b1 : 1'b0);
...
assign j_V_fu_384_p2 = (t_V_8_reg_244 + 32'd1);
