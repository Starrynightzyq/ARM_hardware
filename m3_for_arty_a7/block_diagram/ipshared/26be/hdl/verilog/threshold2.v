...
(* CORE_GENERATION_INFO="threshold2,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.972000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=15,HLS_SYN_DSP=14,HLS_SYN_FF=7528,HLS_SYN_LUT=11999,HLS_VERSION=2018_2}" *)
...
wire    Threshold_l228_U0_img_h_data_stream_0_V_read;
wire   [7:0] Threshold_l228_U0_img_h_1_data_stream_0_V_din;
wire    Threshold_l228_U0_img_h_1_data_stream_0_V_write;
wire    Threshold_l229_U0_ap_start;
wire    Threshold_l229_U0_ap_done;
wire    Threshold_l229_U0_ap_continue;
wire    Threshold_l229_U0_ap_idle;
wire    Threshold_l229_U0_ap_ready;
wire    Threshold_l229_U0_img_s_data_stream_0_V_read;
wire   [7:0] Threshold_l229_U0_img_s_1_data_stream_0_V_din;
wire    Threshold_l229_U0_img_s_1_data_stream_0_V_write;
...
wire    And230_U0_ap_start;
wire    And230_U0_ap_done;
wire    And230_U0_ap_continue;
wire    And230_U0_ap_idle;
wire    And230_U0_ap_ready;
wire    And230_U0_src1_data_stream_V_read;
wire    And230_U0_src2_data_stream_V_read;
wire   [7:0] And230_U0_dst_data_stream_V_din;
wire    And230_U0_dst_data_stream_V_write;
wire    And_U0_ap_start;
wire    And_U0_ap_done;
wire    And_U0_ap_continue;
wire    And_U0_ap_idle;
wire    And_U0_ap_ready;
wire    And_U0_src1_data_stream_V_read;
wire    And_U0_src2_data_stream_V_read;
wire   [7:0] And_U0_dst_data_stream_V_din;
wire    And_U0_dst_data_stream_V_write;
...
wire    img_hv_data_stream_0_full_n;
wire   [7:0] img_hv_data_stream_0_dout;
wire    img_hv_data_stream_0_empty_n;
...
wire    Threshold_l229_U0_start_full_n;
wire    Threshold_l229_U0_start_write;
wire    Threshold_l_U0_start_full_n;
wire    Threshold_l_U0_start_write;
wire    And230_U0_start_full_n;
wire    And230_U0_start_write;
wire    And_U0_start_full_n;
wire    And_U0_start_write;
...
Threshold_l228 Threshold_l228_U0(
    ...
    .rows(rows),
    .cols(cols),
    .img_h_data_stream_0_V_dout(img_h_data_stream_0_dout),
    .img_h_data_stream_0_V_empty_n(img_h_data_stream_0_empty_n),
    .img_h_data_stream_0_V_read(Threshold_l228_U0_img_h_data_stream_0_V_read),
    .img_h_1_data_stream_0_V_din(Threshold_l228_U0_img_h_1_data_stream_0_V_din),
    .img_h_1_data_stream_0_V_full_n(img_h_1_data_stream_s_full_n),
    .img_h_1_data_stream_0_V_write(Threshold_l228_U0_img_h_1_data_stream_0_V_write),
    .max_h(max_h),
    .min_h(min_h)
);

Threshold_l229 Threshold_l229_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(Threshold_l229_U0_ap_start),
    .ap_done(Threshold_l229_U0_ap_done),
    .ap_continue(Threshold_l229_U0_ap_continue),
    .ap_idle(Threshold_l229_U0_ap_idle),
    .ap_ready(Threshold_l229_U0_ap_ready),
    .rows(rows),
    .cols(cols),
    .img_s_data_stream_0_V_dout(img_s_data_stream_0_dout),
    .img_s_data_stream_0_V_empty_n(img_s_data_stream_0_empty_n),
    .img_s_data_stream_0_V_read(Threshold_l229_U0_img_s_data_stream_0_V_read),
    .img_s_1_data_stream_0_V_din(Threshold_l229_U0_img_s_1_data_stream_0_V_din),
    .img_s_1_data_stream_0_V_full_n(img_s_1_data_stream_s_full_n),
    .img_s_1_data_stream_0_V_write(Threshold_l229_U0_img_s_1_data_stream_0_V_write),
    .max_s(max_s),
    .min_s(min_s)
);
...
And230 And230_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(And230_U0_ap_start),
    .ap_done(And230_U0_ap_done),
    .ap_continue(And230_U0_ap_continue),
    .ap_idle(And230_U0_ap_idle),
    .ap_ready(And230_U0_ap_ready),
    .src1_rows_V(rows),
    .src1_cols_V(cols),
    .src1_data_stream_V_dout(img_h_1_data_stream_s_dout),
    .src1_data_stream_V_empty_n(img_h_1_data_stream_s_empty_n),
    .src1_data_stream_V_read(And230_U0_src1_data_stream_V_read),
    .src2_data_stream_V_dout(img_v_1_data_stream_s_dout),
    .src2_data_stream_V_empty_n(img_v_1_data_stream_s_empty_n),
    .src2_data_stream_V_read(And230_U0_src2_data_stream_V_read),
    .dst_data_stream_V_din(And230_U0_dst_data_stream_V_din),
    .dst_data_stream_V_full_n(img_hv_data_stream_0_full_n),
    .dst_data_stream_V_write(And230_U0_dst_data_stream_V_write)
);

And_r And_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(And_U0_ap_start),
    .ap_done(And_U0_ap_done),
    .ap_continue(And_U0_ap_continue),
    .ap_idle(And_U0_ap_idle),
    .ap_ready(And_U0_ap_ready),
    .src1_rows_V(rows),
    .src1_cols_V(cols),
    .src1_data_stream_V_dout(img_hv_data_stream_0_dout),
    .src1_data_stream_V_empty_n(img_hv_data_stream_0_empty_n),
    .src1_data_stream_V_read(And_U0_src1_data_stream_V_read),
    .src2_data_stream_V_dout(img_s_1_data_stream_s_dout),
    .src2_data_stream_V_empty_n(img_s_1_data_stream_s_empty_n),
    .src2_data_stream_V_read(And_U0_src2_data_stream_V_read),
    .dst_data_stream_V_din(And_U0_dst_data_stream_V_din),
    .dst_data_stream_V_full_n(img_hls_data_stream_s_full_n),
    .dst_data_stream_V_write(And_U0_dst_data_stream_V_write)
);
...
fifo_w8_d2_A img_h_data_stream_0_U(
    ...
    .if_read(Threshold_l228_U0_img_h_data_stream_0_V_read)
);
...
fifo_w8_d2_A img_s_data_stream_0_U(
    ...
    .if_read(Threshold_l229_U0_img_s_data_stream_0_V_read)
);
...
fifo_w8_d2_A img_h_1_data_stream_s_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Threshold_l228_U0_img_h_1_data_stream_0_V_din),
    .if_full_n(img_h_1_data_stream_s_full_n),
    .if_write(Threshold_l228_U0_img_h_1_data_stream_0_V_write),
    .if_dout(img_h_1_data_stream_s_dout),
    .if_empty_n(img_h_1_data_stream_s_empty_n),
    .if_read(And230_U0_src1_data_stream_V_read)
);
...
fifo_w8_d2_A img_s_1_data_stream_s_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Threshold_l229_U0_img_s_1_data_stream_0_V_din),
    .if_full_n(img_s_1_data_stream_s_full_n),
    .if_write(Threshold_l229_U0_img_s_1_data_stream_0_V_write),
    .if_dout(img_s_1_data_stream_s_dout),
    .if_empty_n(img_s_1_data_stream_s_empty_n),
    .if_read(And_U0_src2_data_stream_V_read)
);
...
fifo_w8_d2_A img_v_1_data_stream_s_U(
    ...
    .if_read(And230_U0_src2_data_stream_V_read)
);

fifo_w8_d2_A img_hv_data_stream_0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(And230_U0_dst_data_stream_V_din),
    .if_full_n(img_hv_data_stream_0_full_n),
    .if_write(And230_U0_dst_data_stream_V_write),
    .if_dout(img_hv_data_stream_0_dout),
    .if_empty_n(img_hv_data_stream_0_empty_n),
    .if_read(And_U0_src1_data_stream_V_read)
);
...
fifo_w8_d2_A img_hls_data_stream_s_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(And_U0_dst_data_stream_V_din),
    .if_full_n(img_hls_data_stream_s_full_n),
    .if_write(And_U0_dst_data_stream_V_write),
...
assign And230_U0_ap_continue = 1'b1;

assign And230_U0_ap_start = 1'b1;

assign And230_U0_start_full_n = 1'b1;

assign And230_U0_start_write = 1'b0;

assign And_U0_ap_continue = 1'b1;

assign And_U0_ap_start = 1'b1;

assign And_U0_start_full_n = 1'b1;

assign And_U0_start_write = 1'b0;
...
assign Threshold_l228_U0_ap_start = 1'b1;

assign Threshold_l228_U0_start_full_n = 1'b1;

assign Threshold_l228_U0_start_write = 1'b0;

assign Threshold_l229_U0_ap_continue = 1'b1;

assign Threshold_l229_U0_ap_start = 1'b1;

assign Threshold_l229_U0_start_full_n = 1'b1;

assign Threshold_l229_U0_start_write = 1'b0;
