...
wire   [31:0] rows;
wire   [31:0] cols;
wire    Block_Mat_exit46_pro_U0_ap_start;
wire    Block_Mat_exit46_pro_U0_ap_done;
wire    Block_Mat_exit46_pro_U0_ap_continue;
wire    Block_Mat_exit46_pro_U0_ap_idle;
wire    Block_Mat_exit46_pro_U0_ap_ready;
wire   [31:0] Block_Mat_exit46_pro_U0_img_1_rows_V_out_din;
wire    Block_Mat_exit46_pro_U0_img_1_rows_V_out_write;
wire   [31:0] Block_Mat_exit46_pro_U0_img_1_cols_V_out_din;
wire    Block_Mat_exit46_pro_U0_img_1_cols_V_out_write;
wire   [15:0] Block_Mat_exit46_pro_U0_bound_y_min_out_din;
wire    Block_Mat_exit46_pro_U0_bound_y_min_out_write;
wire   [15:0] Block_Mat_exit46_pro_U0_bound_y_max_out_din;
wire    Block_Mat_exit46_pro_U0_bound_y_max_out_write;
...
wire   [31:0] draw_line_U0_dst_rows_V_out_din;
wire    draw_line_U0_dst_rows_V_out_write;
wire   [31:0] draw_line_U0_dst_cols_V_out_din;
...
reg    ap_sync_reg_Block_Mat_exit46_pro_U0_ap_ready;
wire    ap_sync_Block_Mat_exit46_pro_U0_ap_ready;
reg   [1:0] Block_Mat_exit46_pro_U0_ap_ready_count;
reg    ap_sync_reg_draw_line_U0_ap_ready;
wire    ap_sync_draw_line_U0_ap_ready;
reg   [1:0] draw_line_U0_ap_ready_count;
wire    Block_Mat_exit46_pro_U0_start_full_n;
wire    Block_Mat_exit46_pro_U0_start_write;
...
#0 ap_sync_reg_Block_Mat_exit46_pro_U0_ap_ready = 1'b0;
#0 Block_Mat_exit46_pro_U0_ap_ready_count = 2'd0;
...
Block_Mat_exit46_pro Block_Mat_exit46_pro_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(Block_Mat_exit46_pro_U0_ap_start),
    .ap_done(Block_Mat_exit46_pro_U0_ap_done),
    .ap_continue(Block_Mat_exit46_pro_U0_ap_continue),
    .ap_idle(Block_Mat_exit46_pro_U0_ap_idle),
    .ap_ready(Block_Mat_exit46_pro_U0_ap_ready),
    .rows(rows),
    .cols(cols),
    ...
    .img_1_rows_V_out_din(Block_Mat_exit46_pro_U0_img_1_rows_V_out_din),
    .img_1_rows_V_out_full_n(img_1_rows_V_c_full_n),
    .img_1_rows_V_out_write(Block_Mat_exit46_pro_U0_img_1_rows_V_out_write),
    .img_1_cols_V_out_din(Block_Mat_exit46_pro_U0_img_1_cols_V_out_din),
    .img_1_cols_V_out_full_n(img_1_cols_V_c_full_n),
    .img_1_cols_V_out_write(Block_Mat_exit46_pro_U0_img_1_cols_V_out_write),
    .bound_y_min_out_din(Block_Mat_exit46_pro_U0_bound_y_min_out_din),
    .bound_y_min_out_full_n(bound_y_min_c_full_n),
    .bound_y_min_out_write(Block_Mat_exit46_pro_U0_bound_y_min_out_write),
    .bound_y_max_out_din(Block_Mat_exit46_pro_U0_bound_y_max_out_din),
    .bound_y_max_out_full_n(bound_y_max_c_full_n),
    .bound_y_max_out_write(Block_Mat_exit46_pro_U0_bound_y_max_out_write),
    .ap_return_0(Block_Mat_exit46_pro_U0_ap_return_0),
    .ap_return_1(Block_Mat_exit46_pro_U0_ap_return_1)
);
...
draw_line draw_line_U0(
    ...
    .start_out(draw_line_U0_start_out),
    .start_write(draw_line_U0_start_write),
    ...
    .dst_rows_V_out_din(draw_line_U0_dst_rows_V_out_din),
    .dst_rows_V_out_full_n(img_1_rows_V_c14_full_n),
    .dst_rows_V_out_write(draw_line_U0_dst_rows_V_out_write),
    .dst_cols_V_out_din(draw_line_U0_dst_cols_V_out_din),
    .dst_cols_V_out_full_n(img_1_cols_V_c15_full_n),
    .dst_cols_V_out_write(draw_line_U0_dst_cols_V_out_write)
);
...
Mat2AXIvideo Mat2AXIvideo_U0(
    ...
    .img_rows_V_dout(img_1_rows_V_c14_dout),
    .img_rows_V_empty_n(img_1_rows_V_c14_empty_n),
    .img_rows_V_read(Mat2AXIvideo_U0_img_rows_V_read),
    .img_cols_V_dout(img_1_cols_V_c15_dout),
    .img_cols_V_empty_n(img_1_cols_V_c15_empty_n),
...
fifo_w32_d3_A img_1_rows_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit46_pro_U0_img_1_rows_V_out_din),
    .if_full_n(img_1_rows_V_c_full_n),
    .if_write(Block_Mat_exit46_pro_U0_img_1_rows_V_out_write),
...
fifo_w32_d3_A img_1_cols_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit46_pro_U0_img_1_cols_V_out_din),
    .if_full_n(img_1_cols_V_c_full_n),
    .if_write(Block_Mat_exit46_pro_U0_img_1_cols_V_out_write),
...
fifo_w16_d3_A bound_y_min_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit46_pro_U0_bound_y_min_out_din),
    .if_full_n(bound_y_min_c_full_n),
    .if_write(Block_Mat_exit46_pro_U0_bound_y_min_out_write),
...
fifo_w16_d3_A bound_y_max_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit46_pro_U0_bound_y_max_out_din),
    .if_full_n(bound_y_max_c_full_n),
    .if_write(Block_Mat_exit46_pro_U0_bound_y_max_out_write),
...
fifo_w32_d2_A img_0_rows_V_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit46_pro_U0_ap_return_0),
...
fifo_w32_d2_A img_0_cols_V_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit46_pro_U0_ap_return_1),
...
fifo_w32_d2_A img_1_rows_V_c14_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(draw_line_U0_dst_rows_V_out_din),
    .if_full_n(img_1_rows_V_c14_full_n),
    .if_write(draw_line_U0_dst_rows_V_out_write),
    .if_dout(img_1_rows_V_c14_dout),
    .if_empty_n(img_1_rows_V_c14_empty_n),
    .if_read(Mat2AXIvideo_U0_img_rows_V_read)
);

fifo_w32_d2_A img_1_cols_V_c15_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(draw_line_U0_dst_cols_V_out_din),
    .if_full_n(img_1_cols_V_c15_full_n),
    .if_write(draw_line_U0_dst_cols_V_out_write),
    .if_dout(img_1_cols_V_c15_dout),
    .if_empty_n(img_1_cols_V_c15_empty_n),
...
start_for_Mat2AXIbkb start_for_Mat2AXIbkb_U(
    ...
    .if_write(draw_line_U0_start_write),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_Mat_exit46_pro_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_Block_Mat_exit46_pro_U0_ap_ready <= 1'b0;
        end else begin
            ap_sync_reg_Block_Mat_exit46_pro_U0_ap_ready <= ap_sync_Block_Mat_exit46_pro_U0_ap_ready;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((Block_Mat_exit46_pro_U0_ap_done & Block_Mat_exit46_pro_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_img_0_cols_V_channel <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Block_Mat_exit46_pro_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Block_Mat_exit46_pro_U0_ap_ready_count <= (Block_Mat_exit46_pro_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (1'b1 == Block_Mat_exit46_pro_U0_ap_ready))) begin
        Block_Mat_exit46_pro_U0_ap_ready_count <= (Block_Mat_exit46_pro_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit46_pro_U0_ap_continue = (ap_sync_channel_write_img_0_rows_V_channel & ap_sync_channel_write_img_0_cols_V_channel);

assign Block_Mat_exit46_pro_U0_ap_start = ((ap_sync_reg_Block_Mat_exit46_pro_U0_ap_ready ^ 1'b1) & ap_start);

assign Block_Mat_exit46_pro_U0_start_full_n = 1'b1;

assign Block_Mat_exit46_pro_U0_start_write = 1'b0;
...
assign ap_channel_done_img_0_cols_V_channel = ((ap_sync_reg_channel_write_img_0_cols_V_channel ^ 1'b1) & Block_Mat_exit46_pro_U0_ap_done);

assign ap_channel_done_img_0_rows_V_channel = ((ap_sync_reg_channel_write_img_0_rows_V_channel ^ 1'b1) & Block_Mat_exit46_pro_U0_ap_done);

assign ap_done = Mat2AXIvideo_U0_ap_done;

assign ap_idle = ((img_0_cols_V_channel_empty_n ^ 1'b1) & (img_0_rows_V_channel_empty_n ^ 1'b1) & draw_line_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Block_Mat_exit46_pro_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign ap_sync_Block_Mat_exit46_pro_U0_ap_ready = (ap_sync_reg_Block_Mat_exit46_pro_U0_ap_ready | Block_Mat_exit46_pro_U0_ap_ready);
...
assign ap_sync_ready = (ap_sync_draw_line_U0_ap_ready & ap_sync_Block_Mat_exit46_pro_U0_ap_ready & ap_sync_AXIvideo2Mat_U0_ap_ready);
