...
reg   [0:0] exitcond_i_reg_510;
reg   [0:0] brmerge_i_reg_519;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond9_i_fu_408_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_419_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond9_i_fu_408_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        axi_data_V1_i_reg_263 <= tmp_data_V_reg_481;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_510 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        axi_last_V1_i_reg_253 <= tmp_last_V_reg_489;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_419_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_fu_182 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_419_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        t_V_10_reg_284 <= j_V_fu_424_p2;
    end else if (((exitcond9_i_fu_408_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        t_V_10_reg_284 <= 16'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_419_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        brmerge_i_reg_519 <= brmerge_i_fu_433_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        exitcond_i_reg_510 <= exitcond_i_fu_419_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        i_V_reg_505 <= i_V_fu_413_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((img_cols_V_out_full_n == 1'b0) | (img_rows_V_out_full_n == 1'b0) | (img_cols_V_empty_n == 1'b0) | (img_rows_V_empty_n == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        img_cols_V_read_reg_476 <= img_cols_V_dout;
        img_rows_V_read_reg_471 <= img_rows_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_data_V_reg_481 <= AXI_video_strm_V_data_V_0_data_out;
        tmp_last_V_reg_489 <= AXI_video_strm_V_last_V_0_data_out;
    end
end

always @ (*) begin
    if ((((eol_2_i_reg_354 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op71_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond9_i_fu_408_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_529)) begin
        if ((brmerge_i_reg_519 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_334_p4 = eol_reg_307;
        end else if ((brmerge_i_reg_519 == 1'd0)) begin
...
always @ (*) begin
    if (((exitcond_i_reg_510 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_354 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_519 == 1'd0) & (exitcond_i_reg_510 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_510 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_condition_529 = ((exitcond_i_reg_510 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
always @ (*) begin
    ap_predicate_op71_read_state6 = ((brmerge_i_reg_519 == 1'd0) & (exitcond_i_reg_510 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_433_p2 = (sof_1_i_fu_182 | ap_phi_mux_eol_i_phi_fu_299_p4);

assign exitcond9_i_fu_408_p2 = ((t_V_reg_273 == img_rows_V_read_reg_471) ? 1'b1 : 1'b0);

assign exitcond_i_fu_419_p2 = ((t_V_10_reg_284 == img_cols_V_read_reg_476) ? 1'b1 : 1'b0);

assign i_V_fu_413_p2 = (t_V_reg_273 + 16'd1);
...
assign j_V_fu_424_p2 = (t_V_10_reg_284 + 16'd1);
