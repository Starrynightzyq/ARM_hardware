...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((exitcond_i_reg_277_pp0_iter1_reg == 1'd0) & (dst_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_i_reg_277 == 1'd0) & (src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((exitcond_i_reg_277_pp0_iter1_reg == 1'd0) & (dst_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_i_reg_277 == 1'd0) & (src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((exitcond_i_reg_277_pp0_iter1_reg == 1'd0) & (dst_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_i_reg_277 == 1'd0) & (src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((exitcond_i_reg_277 == 1'd0) & (src_data_stream_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter2 = ((exitcond_i_reg_277_pp0_iter1_reg == 1'd0) & (dst_data_stream_V_full_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign dst_data_stream_V_din = ((tmp_34_fu_233_p2[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign exitcond5_i_fu_191_p2 = ((t_V_reg_161 == src_rows_V) ? 1'b1 : 1'b0);

assign exitcond_i_fu_202_p2 = ((t_V_3_reg_172 == src_cols_V) ? 1'b1 : 1'b0);

assign i_V_fu_196_p2 = (t_V_reg_161 + 32'd1);

assign j_V_fu_207_p2 = (t_V_3_reg_172 + 32'd1);

assign p_thresh_max_fu_183_p1 = max_v[7:0];

assign p_thresh_min_fu_187_p1 = min_v[7:0];

assign rev7_fu_223_p2 = (ult_reg_286 ^ 1'd1);

assign rev9_fu_228_p2 = (ult8_reg_291 ^ 1'd1);

assign tmp_34_fu_233_p2 = (rev9_fu_228_p2 & rev7_fu_223_p2);

assign ult8_fu_218_p2 = ((src_data_stream_V_dout < p_thresh_min_fu_187_p1) ? 1'b1 : 1'b0);

assign ult_fu_213_p2 = ((p_thresh_max_fu_183_p1 < src_data_stream_V_dout) ? 1'b1 : 1'b0);
