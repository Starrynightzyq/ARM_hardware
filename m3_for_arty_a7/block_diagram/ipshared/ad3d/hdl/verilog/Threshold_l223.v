...
assign dst_data_stream_V_din = ((tmp_30_fu_243_p2[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign exitcond4_i_fu_201_p2 = ((t_V_reg_179 == src_rows_V_read_reg_268) ? 1'b1 : 1'b0);

assign exitcond_i_fu_212_p2 = ((t_V_2_reg_190 == src_cols_V_read_reg_273) ? 1'b1 : 1'b0);

assign i_V_fu_206_p2 = (t_V_reg_179 + 16'd1);

assign j_V_fu_217_p2 = (t_V_2_reg_190 + 16'd1);

assign rev3_fu_233_p2 = (ult_reg_296 ^ 1'd1);

assign rev5_fu_238_p2 = (ult4_reg_301 ^ 1'd1);

assign tmp_30_fu_243_p2 = (rev5_fu_238_p2 & rev3_fu_233_p2);
