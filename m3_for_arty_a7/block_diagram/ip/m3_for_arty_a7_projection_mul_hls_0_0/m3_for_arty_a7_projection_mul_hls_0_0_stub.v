...
// Date        : Mon Jul 22 16:35:38 2019
// Host        : desktopzyq running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub
//               C:/OneDriveLocal/ARM_CP/backup/hardware/m3_for_arty_a7/block_diagram/ip/m3_for_arty_a7_projection_mul_hls_0_0/m3_for_arty_a7_projection_mul_hls_0_0_stub.v
...
module m3_for_arty_a7_projection_mul_hls_0_0(bound_min_ce0, bound_min_we0, bound_max_ce0, 
  bound_max_we0, s_axi_AXILiteS_AWADDR, s_axi_AXILiteS_AWVALID, s_axi_AXILiteS_AWREADY, 
  ...
  s_axi_AXILiteS_RVALID, s_axi_AXILiteS_RREADY, ap_clk, ap_rst_n, interrupt, input_r_TVALID, 
  input_r_TREADY, input_r_TDATA, input_r_TKEEP, input_r_TSTRB, input_r_TUSER, input_r_TLAST, 
  input_r_TID, input_r_TDEST, output_r_TVALID, output_r_TREADY, output_r_TDATA, 
  output_r_TKEEP, output_r_TSTRB, output_r_TUSER, output_r_TLAST, output_r_TID, 
  output_r_TDEST, bound_min_address0, bound_min_d0, bound_min_q0, bound_max_address0, 
  bound_max_d0, bound_max_q0)
/* synthesis syn_black_box black_box_pad_pin="bound_min_ce0,bound_min_we0,bound_max_ce0,bound_max_we0,s_axi_AXILiteS_AWADDR[5:0],s_axi_AXILiteS_AWVALID,s_axi_AXILiteS_AWREADY,s_axi_AXILiteS_WDATA[31:0],s_axi_AXILiteS_WSTRB[3:0],s_axi_AXILiteS_WVALID,s_axi_AXILiteS_WREADY,s_axi_AXILiteS_BRESP[1:0],s_axi_AXILiteS_BVALID,s_axi_AXILiteS_BREADY,s_axi_AXILiteS_ARADDR[5:0],s_axi_AXILiteS_ARVALID,s_axi_AXILiteS_ARREADY,s_axi_AXILiteS_RDATA[31:0],s_axi_AXILiteS_RRESP[1:0],s_axi_AXILiteS_RVALID,s_axi_AXILiteS_RREADY,ap_clk,ap_rst_n,interrupt,input_r_TVALID,input_r_TREADY,input_r_TDATA[7:0],input_r_TKEEP[0:0],input_r_TSTRB[0:0],input_r_TUSER[0:0],input_r_TLAST[0:0],input_r_TID[0:0],input_r_TDEST[0:0],output_r_TVALID,output_r_TREADY,output_r_TDATA[7:0],output_r_TKEEP[0:0],output_r_TSTRB[0:0],output_r_TUSER[0:0],output_r_TLAST[0:0],output_r_TID[0:0],output_r_TDEST[0:0],bound_min_address0[2:0],bound_min_d0[15:0],bound_min_q0[15:0],bound_max_address0[2:0],bound_max_d0[15:0],bound_max_q0[15:0]" */;
