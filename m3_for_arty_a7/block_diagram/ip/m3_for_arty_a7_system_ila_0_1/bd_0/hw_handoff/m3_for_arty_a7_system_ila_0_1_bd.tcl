...
proc create_root_design { parentCell } {
  ...
  set probe0 [ create_bd_port -dir I -from 159 -to 0 probe0 ]
  set probe1 [ create_bd_port -dir I -from 159 -to 0 probe1 ]
  set probe2 [ create_bd_port -dir I -from 3 -to 0 probe2 ]
  set probe3 [ create_bd_port -dir I -from 0 -to 0 probe3 ]
  set probe4 [ create_bd_port -dir I -from 159 -to 0 probe4 ]
  set probe5 [ create_bd_port -dir I -from 159 -to 0 probe5 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE4_WIDTH {160} \
   CONFIG.C_PROBE5_MU_CNT {1} \
   CONFIG.C_PROBE5_TYPE {0} \
   CONFIG.C_PROBE5_WIDTH {160} \
...
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_ports SLOT_3_AXIS] [get_bd_intf_pins g_inst/slot_3_axis]
  ...
  connect_bd_net -net net_slot_0_axis_tdest [get_bd_pins g_inst/m_slot_0_axis_tdest] [get_bd_pins ila_lib/probe11]
  connect_bd_net -net net_slot_0_axis_tid [get_bd_pins g_inst/m_slot_0_axis_tid] [get_bd_pins ila_lib/probe12]
  connect_bd_net -net net_slot_0_axis_tkeep [get_bd_pins g_inst/m_slot_0_axis_tkeep] [get_bd_pins ila_lib/probe13]
  ...
  connect_bd_net -net net_slot_0_axis_tstrb [get_bd_pins g_inst/m_slot_0_axis_tstrb] [get_bd_pins ila_lib/probe14]
  connect_bd_net -net net_slot_0_axis_tuser [get_bd_pins g_inst/m_slot_0_axis_tuser] [get_bd_pins ila_lib/probe15]
  ...
  connect_bd_net -net net_slot_1_axis_tstrb [get_bd_pins g_inst/m_slot_1_axis_tstrb] [get_bd_pins ila_lib/probe20]
  ...
  connect_bd_net -net net_slot_3_axis_tdest [get_bd_pins g_inst/m_slot_3_axis_tdest] [get_bd_pins ila_lib/probe30]
  connect_bd_net -net net_slot_3_axis_tid [get_bd_pins g_inst/m_slot_3_axis_tid] [get_bd_pins ila_lib/probe31]
  connect_bd_net -net net_slot_3_axis_tkeep [get_bd_pins g_inst/m_slot_3_axis_tkeep] [get_bd_pins ila_lib/probe32]
  connect_bd_net -net net_slot_3_axis_tlast [get_bd_pins g_inst/m_slot_3_axis_tlast] [get_bd_pins ila_lib/probe37]
  connect_bd_net -net net_slot_3_axis_tready [get_bd_pins g_inst/m_slot_3_axis_tready] [get_bd_pins ila_lib/probe36]
  connect_bd_net -net net_slot_3_axis_tstrb [get_bd_pins g_inst/m_slot_3_axis_tstrb] [get_bd_pins ila_lib/probe33]
  connect_bd_net -net net_slot_3_axis_tuser [get_bd_pins g_inst/m_slot_3_axis_tuser] [get_bd_pins ila_lib/probe34]
  connect_bd_net -net net_slot_3_axis_tvalid [get_bd_pins g_inst/m_slot_3_axis_tvalid] [get_bd_pins ila_lib/probe35]
