...
module bd_c8ed
   (SLOT_0_AXIS_tdata,
    ...
    clk,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_0_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXIS, CLK_DOMAIN m3_for_arty_a7_mig_7series_0_1_ui_clk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, LAYERED_METADATA undef, PHASE 0, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]SLOT_0_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_4_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_4_AXIS, CLK_DOMAIN m3_for_arty_a7_mig_7series_0_1_ui_clk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, LAYERED_METADATA undef, PHASE 0, TDATA_NUM_BYTES 3, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [23:0]SLOT_4_AXIS_tdata;
  ...
  bd_c8ed_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe11(net_slot_2_axis_tdest),
        .probe12(net_slot_2_axis_tid),
        .probe13(net_slot_2_axis_tkeep),
        .probe14(net_slot_2_axis_tstrb),
        ...
        .probe21(net_slot_3_axis_tuser),
        .probe22(net_slot_3_axis_tvalid),
        .probe23(net_slot_3_axis_tready),
        .probe24(net_slot_3_axis_tlast),
        .probe25(net_slot_4_axis_tdata),
        .probe26(net_slot_4_axis_tstrb),
        ...
        .probe31(net_slot_5_axis_tkeep),
        .probe32(net_slot_5_axis_tuser),
        .probe33(net_slot_5_axis_tvalid),
        .probe34(net_slot_5_axis_tready),
        .probe35(net_slot_5_axis_tlast),
        .probe36(net_slot_6_axis_tdata),
        .probe37(net_slot_6_axis_tuser),
        .probe38(net_slot_6_axis_tvalid),
        .probe39(net_slot_6_axis_tready),
        .probe4(net_slot_0_axis_tlast),
        .probe40(net_slot_6_axis_tlast),
