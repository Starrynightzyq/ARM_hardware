...
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS33} [get_ports char_valid]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports char_valid_c]
...
connect_debug_port u_ila_0/probe0 [get_nets [list m3_for_arty_a7_i/ov_cmos_char_valid_c_o_0]]
