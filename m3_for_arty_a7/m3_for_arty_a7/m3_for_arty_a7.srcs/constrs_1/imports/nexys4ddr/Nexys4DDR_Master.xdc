...
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { shift_0[0]  }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { shift_0[1] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { shift_0[2] }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
